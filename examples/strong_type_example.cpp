...
int main()
{
    using player_id_type = expressive::strong_type<player_id_tag, int>;
    using ship_id_type = expressive::strong_type<ship_id_tag, int>;
    ...
    auto another_player_id = expressive::strong_int<player_id_tag>{2};
